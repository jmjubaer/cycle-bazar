...
const FeaturedProducts = () => {
    ...
    return (
        <div className='container py-20'>
            <div className=''>
                <h3 data-aos="fade-right" className='text-xl font-medium text-muted'>
                    Featured Bicycle
                </h3>
                <h2 data-aos="fade-right"  data-aos-delay="200" className=' text-4xl mt-3  font-semibold secondary_font'>
