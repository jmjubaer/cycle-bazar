        ...
        <div className='container'>
            <div className='grid grid-cols-2 items-center'>
                <div className='pr-10'>
                    ...
                    <h2 className=' text-4xl my-5 font-semibold secondary_font'>
            ...
            <div className='text-center py-24'>
                ...
                <h2 className=' text-4xl my-3 font-semibold secondary_font'>
                    Meet Our Team
                </h2>
                <p className='w-1/2 mx-auto mt-5 font-medium text-gray-500'>
                ...
                <div className='grid mt-16 grid-cols-3 justify-between gap-10'>
                    <div className=''>
                        <img src={founder} alt='' className="w-full object-cover rounded-xl"/>
                        <h2 className="secondary_font font-semibold text-4xl mt-5">Henry Mason</h2>
                        <p className="text-lg font-semibold">Founder CycleBazar</p>
                    </div>
                    <div className=''>
                        <img src={ceo} alt='' className="w-full object-cover rounded-xl"/>
                        <h2 className="secondary_font font-semibold text-4xl mt-5">Steven Snow</h2>
                        <p className="text-lg font-semibold">CEO CycleBazar</p>
                    </div>
                    <div className=''>
                        <img src={cto} alt='' className="w-full object-cover rounded-xl"/>
                        <h2 className="secondary_font font-semibold text-4xl mt-5">Alisha Morris</h2>
